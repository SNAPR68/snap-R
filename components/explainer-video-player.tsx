...
const EXPLAINER_VIDEO_URL =
  ...
  'https://res.cloudinary.com/drie9liyn/video/upload/v1773330599/snapr-explainer-video.mp4';

// Cloudinary auto-generated poster from a visible frame (5 seconds in — after intro card)
const EXPLAINER_POSTER_URL =
  'https://res.cloudinary.com/drie9liyn/video/upload/so_5,f_jpg,q_80,w_1920/v1773330599/snapr-explainer-video.jpg';
