...
import { INSTAGRAM_POST_TEMPLATES, TEMPLATE_CATEGORIES, TemplateDefinition } from '@/lib/content/templates'
...
export function InstagramPostCreator() {
  ...
  const previewImage = 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=400&h=400&fit=crop'

  const [selectedTemplate, setSelectedTemplate] = useState<TemplateDefinition>(INSTAGRAM_POST_TEMPLATES[0])
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      link.download = `instagram-post-${selectedTemplate.id}-${Date.now()}.png`
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold">Create Instagram Post</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/5 rounded-xl border border-white/10 p-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                {INSTAGRAM_POST_TEMPLATES.map(template => (
                  <button
                    key={template.id}
                  ...
                  >
                    {/* Mini Template Preview - Square */}
                    <div className="aspect-square w-full relative overflow-hidden">
                      <div className="absolute inset-0 scale-[0.15] origin-top-left" style={{ width: '666%', height: '666%' }}>
                        <TemplateRenderer
            ...
            <div className="sticky top-8">
              ...
              <div className="bg-white/5 rounded-xl border border-white/10 p-4">
                ...
                >
                  ...
                  {downloading ? 'Generating...' : downloaded ? 'Downloaded!' : 'Download 1080×1080'}
                </Button>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            {/* Generate Caption */}
            <Link href={`/dashboard/content-studio/create?type=social&listing=${listingId || ''}`}>
              <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-4 hover:border-purple-500/50 transition-all cursor-pointer">
                <div className="flex items-center gap-3">
                  <Sparkles className="w-5 h-5 text-purple-400" />
                  <div>
                    <p className="font-medium text-purple-300">Generate Caption</p>
                    <p className="text-xs text-white/50">AI-powered captions & hashtags</p>
                  </div>
                </div>
              </div>
            </Link>
