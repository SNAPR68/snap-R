...
export function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4">
      <div className="max-w-2xl mx-auto bg-surface-container-high border border-white/10 rounded-2xl p-4 shadow-2xl">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="flex gap-2">
              ...
              <button onClick={acceptAll} className="px-4 py-2 text-sm font-medium text-black bg-accent-gold rounded-lg hover:opacity-90">
                Accept
              </button>
            </div>
          </div>
