...
export const trackPageView = (pageName: string, data?: Record<string, unknown>) => {
  trackEvent({ eventType: 'page_view', eventName: pageName, eventData: data });
};

export const trackClick = (elementName: string, data?: Record<string, unknown>) => {
  trackEvent({ eventType: 'click', eventName: elementName, eventData: data });
};

export const trackEnhancement = (toolType: string, data?: Record<string, unknown>) => {
  trackEvent({ eventType: 'enhancement', eventName: toolType, eventData: data });
};

export const trackAction = (actionName: string, data?: Record<string, unknown>) => {
