    ...
    <div className="min-h-screen bg-surface text-on-surface">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-4 text-white/70">
          <p><strong className="text-on-surface">1.</strong> Open a photo in Studio</p>
          <p><strong className="text-on-surface">2.</strong> Choose an enhancement (try Sky Replacement)</p>
