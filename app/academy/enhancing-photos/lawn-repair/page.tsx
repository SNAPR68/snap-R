    ...
    <div className="min-h-screen bg-surface text-on-surface">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-4 text-white/70">
          ...
          <p><strong className="text-on-surface">Fixes:</strong> Brown patches, drought stress, sparse coverage</p>
          <p><strong className="text-on-surface">Best for:</strong> Exterior photos with visible lawn areas</p>
          <p><strong className="text-on-surface">Note:</strong> Cannot add grass where none exists.</p>
        </div>
      </div>
    </div>
  );
