  ...
  return (
    <div className="min-h-screen bg-surface text-on-surface">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="text-on-surface-muted mb-8">How SnapR&apos;s simple pricing model works.</p>
          ...
          <div className="bg-surface-container-low border border-white/10 rounded-xl p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-on-surface-muted">Enter a property address to create a new listing. This counts toward your monthly listing limit.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-surface-container-low border border-white/10 rounded-xl p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-on-surface-muted">Upload as many photos as you need for that property. No per-photo charges.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-surface-container-low border border-white/10 rounded-xl p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-on-surface-muted">Use any of the 15 AI tools as many times as you want. Try different effects, re-enhance, experiment — it&apos;s all free.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-surface-container-low border border-white/10 rounded-xl p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-on-surface-muted">Generate social posts, videos, emails, property sites, and more — all included in your plan.</p>
              </div>
            </div>
          </div>
        </div>
