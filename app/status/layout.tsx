...
export default function StatusLayout({
  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col">
      ...
      <nav className="border-b border-white/10 bg-surface sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-gold to-gold-dark flex items-center justify-center font-bold text-black text-xl">
              S
            </div>
      ...
      {/* Footer */}
      <footer className="border-t border-white/10 bg-surface py-8 px-6">
