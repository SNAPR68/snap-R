...
export async function GET() {
  try {
    ...
    const scope = 'pages_manage_posts,pages_read_engagement,pages_manage_metadata,publish_video,pages_show_list,instagram_basic,instagram_content_publish,instagram_manage_comments';
