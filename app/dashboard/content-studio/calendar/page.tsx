...
export default function ContentCalendar() {
  ...
  return (
    <div className="min-h-screen bg-surface text-white">
      <header className="h-14 bg-surface border-b border-white/5 flex items-center justify-between px-4">
        ...
        <Link
          ...
          className="flex items-center gap-2 px-4 py-2 bg-accent-gold text-black rounded-lg font-semibold text-sm hover:bg-accent-gold"
        >
              ...
              {days.map((date, i) => {
                ...
                return (
                  <div
                    ...
                    } ${today ? 'bg-accent-gold/10' : ''} ${isOver ? 'bg-accent-gold/10 ring-1 ring-inset ring-accent-gold/40' : ''}`}
                  ...
                  >
                    {date && (
                      <>
                        <div className={`text-sm font-medium mb-2 ${today ? 'text-accent-gold' : 'text-white/70'}`}>
                          {date.getDate()}
                        </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {scheduledPosts
                  ...
                  .map(post => {
                    ...
                    return (
                      <div key={post.id} className="bg-surface rounded-xl border border-white/5 overflow-hidden">
                            ...
                            <div className="flex items-center gap-1.5">
                              ...
                              {post.source === 'auto' && (
                                <span title="Auto-generated by marketing pipeline">
                                  <Sparkles className="w-3 h-3 text-accent-gold flex-shrink-0" />
                                </span>
                              )}
                            </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {scheduledPosts
                  ...
                  .map(post => {
                    const Icon = platformIcons[post.platform] || Instagram
                    return (
                      <div key={post.id} className="bg-surface rounded-xl border border-emerald-500/10 overflow-hidden opacity-80">
      ...
      {showModal && selectedDate && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-surface rounded-2xl w-full max-w-lg border border-white/10">
            ...
            <div className="flex gap-3 p-4 border-t border-white/5">
              ...
              {editingPost?.status !== 'published' && (
                <button
                  ...
                  className="flex-1 py-3 bg-accent-gold text-black rounded-xl font-semibold hover:bg-accent-gold disabled:opacity-50 flex items-center justify-center gap-2"
                >
